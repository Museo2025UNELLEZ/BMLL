...
public class EliminarCategoria extends javax.swing.JFrame {
	...
	public EliminarCategoria() {
        ...
        tb_consulta.getColumnModel().getColumn(1).setCellRenderer(centerRenderer);
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                btn_volverActionPerformed(new ActionEvent(EliminarCategoria.this, ActionEvent.ACTION_PERFORMED, "escape"));
            }
        });
    ...
    private void initComponents() {
        ...
        jPanel1.add(box_titulo, new org.netbeans.lib.awtextra.AbsoluteConstraints(190, 80, 560, -1));
    ...
    try (PreparedStatement ps = con.prepareStatement(sql.toString())) {
        ...
        tb_consulta.getColumnModel().getColumn(colBoton).setCellEditor(new logicaBoton(new JCheckBox(), tb_consulta, "categoria"));
